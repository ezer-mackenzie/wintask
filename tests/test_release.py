...
class ReleaseValidationTests(unittest.TestCase):
    ...
    def test_stable_and_prerelease_versions(self):
        self.assertEqual(validate(self.root, 'v1.0.0', False), '1.0.0')
    ...
    def test_invalid_and_mismatched_tags_are_rejected(self):
        for tag in ('main', 'v99.0.0', 'v1.0.0; echo unsafe', 'v01.0.0', 'v1.0.0-rc.0', 'v1.0.0+build'):
    ...
    def test_github_prerelease_flag_must_match_metadata(self):
        with self.assertRaises(ValueError):
            validate(self.root, 'v1.0.0', True)
